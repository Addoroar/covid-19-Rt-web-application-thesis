...
def plot_data():
    ...
    return render_template('plot.html', plot=plot_json, date_from=date_from, date_to=date_to, states_list=states_list, css=url_for('static', filename='css/style.css'), html_table=result, plot_json_smoothed=plot_json_smoothed, plot_json_posteriors=plot_json_posteriors)
